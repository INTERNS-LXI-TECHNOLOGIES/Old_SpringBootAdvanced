		...
		<div id="sub" align="center">
			...
			<form action="question" method="get">
				...
				<h1>
					...
					%>
					<%
						out.println(question.getQuestionName());
					%>
				</h1>
				<h1>&nbsp</h1>
				<input type="submit" class="button"
					value="<%=question.getOption1()%>"> <input type="submit"
					class="button" value="<%=question.getOption2()%>"> <input
					type="submit" class="button" value="<%=question.getOption3()%>">
				<input type="submit" class="button"
