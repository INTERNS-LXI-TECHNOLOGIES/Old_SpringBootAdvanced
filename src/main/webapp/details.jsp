...
<body>
	...
	<%
        ...
        String resourcePath=((language==null) || language.equals("ENG"))? "../webapps/"+request.getContextPath()+"/resource/english.properties": "../webapps/"+request.getContextPath()+"/resource/malayalam.properties";
